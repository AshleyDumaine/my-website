 ...
 */! function(n) {
	...
	var a = "animsition",
		...
		init : function(t) {
			...
			if (!o && t.unSupportCss.length > 0 && (!o || !this.length))
			...
			return e && i.addOverlay.call(this, t), t.loading && i.addLoading.call(this, t), this.each(function() {
				...
				l || ( t = n.extend({}, t), e.data(a, {
					...
					var t = n(this),
					    e = t.attr("href");
					2 === a.which || a.metaKey || a.shiftKey || -1 !== navigator.platform.toUpperCase().indexOf("WIN") && a.ctrlKey ? window.open(e, "_blank") : i.pageOut.call(o, t, e)
				}))
			})
		},
		...
		addLoading : function(a) {
			n(a.loadingParentElement).append('<div class="' + a.loadingClass + '"></div>')
		},
		...
		pageOut : function(t, o) {
			var e = this,
			    s = n(this),
			    l = s.data(a).options,
			    r = t.data("animsition-out"),
			    c = s.data("animsition-out"),
			    d = t.data("animsition-out-duration"),
			    u = s.data("animsition-out-duration"),
			    m = r ? r : c,
			    h = d ? d : u,
			    p = i.animationCheck.call(e, m, !0, !1),
			    f = i.animationCheck.call(e, h, !1, !1),
			    g = i.optionCheck.call(e, l);
			g ? i.pageOutOverlay.call(e, p, f, o) : i.pageOutBasic.call(e, p, f, o)
		},
	...
	n.fn.animateCallback = function(a) {
		...
		return i[t] ? i[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ?
		void  n.error("Method " + t + " does not exist on jQuery." + a) : i.init.apply(this, arguments)
	}
}); 